...
uses
  ...
  Menus, Buttons, MessengerChatControl;
...
type
  ...
  TDemoForm = class(TForm)
    ...
    procedure MessengerDropFiles(Sender: TObject; const FileNames: array of String);
...
const
  ...
  SAMPLE_MESSAGES: array[0..5] of string = (
    ...
    'Cmd/Ctrl-click lets you select several messages for bulk copy or delete.',
...
begin
  if FPendingInitialFocus and (Messenger.InputMemo <> nil)
    and Messenger.InputMemo.CanSetFocus then
  begin
...
begin
  ...
  begin
    ...
    Messenger.AddIncoming(
      'Integration Bot',
      'TMessengerChat is a Lazarus visual control for messenger-style interfaces with bubbles, replies, emoji, attachments, editing, deleting, and multi-select.',
      FormatDateTime('hh:nn', Now)
    );
    Messenger.AddIncoming(
      'Integration Bot',
...
begin
  ...
  Messenger.AddIncoming('Integration Bot',
    'To enable bulk actions, select messages with Cmd/Ctrl-click. The top selection bar gives Copy, Edit, and Delete.',
    '10:20');
  Messenger.AddOutgoing(
